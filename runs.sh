#python3 main.py -nf_prior None -nf_vardistr None -data goodreads -gpu 0 -metric recall
...
#python3 main.py -nf_prior NAF -num_nafs_prior 3 -nf_vardistr NAF -num_nafs_vardistr 3 -data goodreads -gpu 0  -metric recall
